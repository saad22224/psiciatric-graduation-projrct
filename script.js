...
const moodResponses = {
    ...
    sad: {
        emoji: '😢',
        title: 'حزين',
        message: 'من حقك تحزن وتخرج مشاعرك. الحزن مش ضعف، ده تعبير عن إنسانيتك. احنا هنا جنبك وبنسمعك.',
        quote: '"حتى أظلم الليالي هتنتهي والشمس هتشرق من جديد"'
    },
    anxious: {
        emoji: '😰',
        title: 'قلقان',
    ...
    angry: {
        emoji: '😠',
        title: 'غضبان',
        message: 'الغضب طاقة قوية، حاول تفرغها في رياضة او كتابة. اعد من 1 لـ 10 وخد نفس هادي.',
        quote: '"في كل دقيقة غضب، بتضيع 60 ثانية من راحة البال"'
    },
    tired: {
        emoji: '😴',
        title: 'تعبان',
        message: 'جسمك وعقلك محتاجين راحة. افصل شوية عن الموبايل والناس وادي لنفسك وقت تشحن طاقتك.',
        quote: '"الراحة جزء من العمل، مش تضيع وقت"'
    },
    calm: {
        emoji: '😊',
        title: 'هادي',
